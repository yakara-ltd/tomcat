...
default['tomcat']['ssl_protocol'] = 'TLSv1.2'
default['tomcat']['ssl_enabled_protocols'] = %w(TLSv1.2 TLSv1.1 TLSv1)
# List from https://www.owasp.org/index.php/Securing_tomcat
# Added last two DHE ciphers due to curl failing to support ECDH
default['tomcat']['ssl_ciphers'] = %w(
...
default['tomcat']['key_algorithm'] = 'RSA'
default['tomcat']['key_size'] = '2048'
default['tomcat']['key_signature_algorithm'] = 'SHA256withRSA'
default['tomcat']['truststore_file'] = nil
default['tomcat']['truststore_type'] = 'jks'
default['tomcat']['certificate_alias'] = 'tomcat'
...
default['tomcat']['custom_environment'] = {}
